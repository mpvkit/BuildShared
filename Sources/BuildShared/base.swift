...
public var SharedBuildOptions = ArgumentOptions()
public var SharedBuildPlatforms = PlatformType.allCases

public enum BuildRunner {
    public static func performCommand(_ options: ArgumentOptions) throws {
        ...
        if !options.platforms.isEmpty {
            SharedBuildPlatforms = options.platforms
        }
    }
}
...
open class BaseBuild {
    ...
    public init(library: any BuildLibrary) {
    ...
    open func buildALL() throws {
        ...
        let platforms = SharedBuildPlatforms
    ...
    open func createXCFramework() throws {
        ...
        for framework in frameworks {
            ...
            if SharedBuildOptions.enableSplitPlatform {
...
// AnyBuildLibrary struct removed as it is no longer needed
